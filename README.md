...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0ju1rjg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0ju1rjg.containers.anotherwebservice.com/
...
```
git clone git@github.com:WalysonGO/container-0ju1rjg.git
cd container-0ju1rjg
```
...
```
docker attach container-0ju1rjg
```
